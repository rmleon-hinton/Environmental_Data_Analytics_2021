...
*This assignment seems interesting and useful.*

* Create **clean** outputs to send to others or work on collaboratively
* Sends the code to the console all at once
* Relatively easy user interface
* Records both the code and the results to run it from beginning again and again. 
...
```{r Install_Packages_Chunk, eval=FALSE, include=FALSE}
...
NTL_LTER_data <- read.csv("../Data/Raw/NTL-LTER_Lake_Nutrients_Raw.csv", stringsAsFactors = TRUE)
...
NTL_LTER_processed <- NTL_LTER_data %>%
