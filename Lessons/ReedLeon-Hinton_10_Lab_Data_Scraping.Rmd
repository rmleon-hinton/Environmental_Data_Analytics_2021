...
energy_2019 <- data.frame("State" = as.factor(the_states[2:53]),
                          "Avg_Retail_Price" = as.numeric(gsub(",","",the_price[2:53])),
                          "Net_Capacity" = as.numeric(gsub(",","",the_capacity[2:53])),
                          "Net_Generation" = as.numeric(gsub(",","",net_generation[2:53])),
                          "Total_Retail" = as.numeric(gsub(",","",total_retail[2:53])))
```
