...
#Create a map
mapView(huc8_sf, col.regions = "orange", layer.name = "NC HUC Regions") + 
  mapView(huc8_UN, col.regions = "purple", layer.name = "Upper Neuse Sub-Basin")
...
huc8_sf_wind <-  left_join(huc8_sf, wind_raw, by = c("HUC_8"))
