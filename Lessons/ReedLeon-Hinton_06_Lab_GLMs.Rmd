...
> Answer: null = The mean ozone level greater than or equal to 50 on the AQI index.
          alternative = The mean ozone level is less than 50 on the AQI index. 
...
ggplot(EPAair, aes(x = Year, y = Ozone, color = Year)) +
  geom_boxplot()+
  stat_summary()
...
ln_exercise_3 <- lm(data = EPAair, PM2.5 ~ Ozone)
summary(ln_exercise_3)
