...
#creating a simple sequence of numbers from 1 to 100 which increases by 4 each time called problem_sequence
...
#writing an if statement with multiple statements to cover every scenario for greater than, equal to, or less than. 
...
grade_check <- function(x) {
  if(x >= 50){
    print("This test scores passes the minimum grade requirement")
  }
  else{
...
#checking each score in the vector. You have to use this method due to the nature of the if
#statement only handling a single input. 
