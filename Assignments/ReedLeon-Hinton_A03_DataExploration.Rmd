...
> Answer: The Conc.1..Author variable is non-numeric and, instead, is a character class. This is because the data in the column was not cleanly formatted when reported. There are some "/" and "NR" values within the column which caused R to 
